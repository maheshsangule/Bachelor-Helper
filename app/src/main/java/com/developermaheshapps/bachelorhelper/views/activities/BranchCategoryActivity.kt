...
import com.developermaheshapps.bachelorhelper.databinding.ActivityBranchCategoryBinding
...
import com.developermaheshapps.bachelorhelper.views.adapters.BranchChildAdapter
...
class BranchCategoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = BranchChildAdapter(list, activity)
